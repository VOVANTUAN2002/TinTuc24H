        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="form-group">
                    <label for="tf1"> Số điện thoại </label> <input name="phone" type="text" class="form-control" id="" placeholder="Nhập số điện thoại" value="{{$item->phone }}">
                ...
                <div class="form-group">
                    <label for="tf1">Mật khẩu</label> <input name="password" type="password" class="form-control" id="" placeholder="Nhập mật khẩu" value="{{$item->password }}">
            ...
            <div class="card-body border-top">
                ...
                <div class="row">
                    <div class="col-lg-9">
                        ...
                        <div class="form-group">
                            ...
                            <input name="name" type="text" class="form-control" id="" placeholder="Nhập tên nhân viên" value="{{$item->name }}">
                        ...
                        <div class="form-group">
                            ...
                            <div class="custom-control custom-control-inline custom-radio">
                                <input type="radio" class="custom-control-input" name="gender" id="rd1" checked="" value="{{$item->gender}}">
                                <label class="custom-control-label" for="rd1">Nam</label>
                            </div>
                            <div class="custom-control custom-control-inline custom-radio">
                                <input type="radio" class="custom-control-input" name="gender" id="rd2" value="{{$item->gender}}">
                        ...
                        <div class="form-group">
                            ...
                            <input name="day_of_birth" type="date" class="form-control" id="" placeholder="Nhập ngày sinh " value="{{$item->day_of_birth }}">
                        ...
                        <div class="card card-figure">
                            <figure class="figure">
                                <div class="figure-img">
                                    ...
                                    <a target="_blank" href="/{{ $item->avatar}}" class="img-link" data-size="600x450">
                ...
                <div class="form-group">
                    <label for="tf1"> Địa chỉ </label> <input name="address" type="text" class="form-control" id="" placeholder="Nhập địa chỉ" value="{{ $item->address }}">
                ...
                <div class="form-group">
                    <label for="tf1">Ngày làm việc</label> <input name="start_day" type="date" class="form-control" id="" placeholder="Nhập ngày làm việc" value="{{ $item->start_day }}">
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="form-group">
                            ...
                            <input name="email" type="text" class="form-control" id="" placeholder="Nhập Email" value="{{$item->email }}">
