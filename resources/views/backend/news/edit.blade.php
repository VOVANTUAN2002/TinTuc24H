                    ...
                    <div class="card-body">
                        <div class="form-group">
                            <div class="form-group">
                                ...
                                <input name="puplish_date" type="date" class="form-control" value="{{ news('puplish_date') }}">
                                @if ($errors->any())
                        ...
                        <div class="form-group">
                            ...
                            <input name="title" type="text" class="form-control" placeholder="Nhập tên Tiêu đề" value="{{ news('title') }}">
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="description" type="text" class="form-control" placeholder="Nhập tên Tiêu đề" value="">{{ news('description') }}</textarea>
                            <small class="form-text text-muted"></small>
                            @if ($errors->any())
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="content" type="text" class="form-control" placeholder="Nhập tên Nội dung" value="">{{ news('content') }}</textarea>
                            <small class="form-text text-muted"></small>
                            @if ($errors->any())
                        ...
                        <div class="row">
                            <div class="col-lg-4">
                                <div class="form-group">
                                    ...
                                    <input name="view" type="text" class="form-control" placeholder="Nhập tên Tiêu đề" value="{{ news('view') }}">
                                    <small class="form-text text-muted"></small>
                                    @if ($errors->any())
