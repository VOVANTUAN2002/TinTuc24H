            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item active">
                        <a href="{{route('userGroups.index')}}"><i
                                class="breadcrumb-icon fa fa-angle-left mr-2"></i>Quản Lý
                            Nhóm Nhân Viên</a>
                    </li>
                </ol>
            </nav>
                        ...
                        <div class="form-group">
                            ...
                            <div class="row">
                                ...
                                <div class="list-group list-group-flush list-group-bordered col-lg-4">
                                    <div class="list-group-header" style="color:rgb(50, 219, 101) ;"><h5>  {{ __($group_name) }}</h5> </div>
