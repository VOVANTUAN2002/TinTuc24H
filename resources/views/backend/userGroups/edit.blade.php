    ...
    <form method="post" action="{{route('userGroups.update',$item->id)}}">
        ...
        <div class="card">
            <div class="card-body">
                ...
                <label for="tf1">Tên nhóm</label> <input name="name" value="{{$item->name }}" type="text" class="form-control" id="" placeholder="Nhập tên nhóm"> <small id="" class="form-text text-muted"></small>
                @if ($errors->any())
